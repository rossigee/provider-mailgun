...
- Docker image: `ghcr.io/rossigee/provider-mailgun:v0.8.0` (current)
...
VERSION=v0.8.0 PUSH_EXTERNAL=true ./build-and-push.sh

# Build with Crossplane package
VERSION=v0.8.0 BUILD_PACKAGE=true ./build-and-push.sh
```
...
- **Registry**: `ghcr.io/rossigee/provider-mailgun:v0.8.0`
