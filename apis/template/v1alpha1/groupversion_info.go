...
// Package v1alpha1 contains the v1alpha1 group Template resources of the Mailgun provider.
// +kubebuilder:object:generate=true
// +groupName=template.mailgun.crossplane.io
...
const (
	Group   = "template.mailgun.crossplane.io"
	Version = "v1alpha1"
)
